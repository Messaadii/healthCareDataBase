...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	void updateUserPasswordById(Long userId, String userPassword);
	...
	@Query(value="select case"
			...
			+ " when u.user_type = 'admin' then concat(a.admin_full_name)"
			+ " end as name"
			+ " from users u, doctors d, pharmacies ph, patients p,secretaries s, admins a"
			...
			+ " when u.user_type = 'admin' then a.user_id=u.user_id"
