...
public class Resource {
	...
	public boolean existsByUserName(@PathVariable(name="username") String username) {
		if(doctorRepository.existsByDoctorUserName(username)|| patientRepository.existsByPatientUserName(username)||pharmacyRepository.existsByPharmacyUserName(username))
			return true;
		else
			return false;
	}
