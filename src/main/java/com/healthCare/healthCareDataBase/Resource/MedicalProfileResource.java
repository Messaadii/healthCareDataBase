...
public class MedicalProfileResource {
	...
	@GetMapping(value="getMedicalProfileByPatientId/{id}")
	public MedicalProfile getMedicalProfileByPatientId(@PathVariable("id") Integer id) {
		return medicalProfileRepository.getMedicalProfileByPatientId(id);
	}
